...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p(data-aos="fade-right") La inteligencia artificial (IA) ha generado un impacto profundo y creciente en los distintos ámbitos de la vida humana, abarcando desde lo cotidiano hasta los sectores más especializados de la industria. Desde su origen, la IA ha evolucionado rápidamente, ofreciendo soluciones que permiten optimizar procesos y mejorar la productividad.

    .bg-full-width-2.bg-fondo-1
      .p-4.p-md-5
        .row.mb-5.justify-content-center
          .col-8.col-lg-3.order-2(data-aos="fade-right")
